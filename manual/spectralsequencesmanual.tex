...
Another option is to increase the static memory caps for \pdfLaTeX. See \href{https://tex.stackexchange.com/questions/26205/increase-latex-capacity}{this \TeX stack exchange post} for instructions on how to do this.
...
\begin{codeexample}[]
\begin{sseqdata}[ name = boundingboxex, x range = {0}{2}, y range = {0}{2} ]
\end{sseqdata}
...
\path[background] (\xmin,\ymin-2) -- (\xmax,\ymax+1);
\end{sseqpage}
