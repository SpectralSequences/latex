...
\sseq@globalkeys{%
    ...
    range check sideways/.code={\sseq@rangechecktrue\sseq@rangecheck@sidewaystrue},
    range check sideways/.sseq default code={%
        \def\sseq@rangecheck@default{\global\sseq@rangechecktrue}%
        \def\sseq@rangecheck@sideways@default{\global\sseq@rangecheck@sidewaystrue}%
    },
