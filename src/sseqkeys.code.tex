...
\sseq@pgfqkeysdirlist{/sseqpages/differential,/sseqpages/struct line,/sseqpages/extension}{
...
\sseq@newstyles{/sseqpages/label,/sseqpages}{edge, label, edge label, differential label, struct line label, extension label}
...
\sseq@newstyles{/sseqpages/extension,/sseqpages}{extension}
