...
\def\sseq@totalhorizontalmargin@yframe{(\sseq@ylabelgap + 2em + \sseq@ytick@start@extend + 2*\sseq@yaxisgap)}
...
\def\sseq@totalhorizontalmargin@ynone{(\sseq@clip@padding@left + \sseq@clip@padding@right)}

\def\sseq@totalverticalmargin@xborder{(\sseq@yaxis@tail + \sseq@xaxisgap + \sseq@yaxis@end@extend + \sseq@clip@padding@top)}
\def\sseq@totalverticalmargin@xframe{\sseq@yaxis@tail + \sseq@xaxisgap + \sseq@yaxis@end@extend + \sseq@clip@padding@top)}
...
\def\sseq@totalverticalmargin@xnone{(\sseq@clip@padding@bottom + \sseq@clip@padding@top)}
