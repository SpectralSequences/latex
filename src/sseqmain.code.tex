...
%
    ...
    \ifsseq@rangecheck
        ...
        %
        % \sseq@tempydimen = \dimexpr \textheight - \sseq@clip@padding@top - \sseq@yaxis@end@extend - \sseq@yaxis@start@extend - \sseq@xaxisgap \relax
        % \sseq@tempxdimen = \dimexpr \textwidth -\sseq@clip@padding@right - \sseq@xaxis@end@extend - \sseq@xaxis@start@extend - \sseq@yaxisgap \relax
%
        \sseq@tempxdimen = \dimexpr \linewidth - \sseq@totalhorizontalmargin - 0.1pt
        \sseq@tempydimen = \dimexpr \textheight - \sseq@totalverticalmargin - 0.1pt

        % \sseq@tempxdimen = \dimexpr \textwidth -\sseq@xaxis@tail - \sseq@yaxisgap - \sseq@xaxis@end@extend - \sseq@clip@padding@right - 0.1pt
        % \sseq@tempydimen = \dimexpr \textheight -\sseq@yaxis@tail - \sseq@xaxisgap - \sseq@yaxis@end@extend - \sseq@clip@padding@top - 0.1pt
        ...
        \fi
%
        \pgfmathparse{\sseq@tempxdimen/1cm/(\sseq@xmax-\sseq@xmin)}
        \sseq@tempx = \numexpr \sseq@tempxdimen /\sseq@xscalecm \relax
        \ifdim \pgfmathresult cm < \sseq@xscale cm
            \sseq@tempx = \numexpr \sseq@tempxdimen /\sseq@xscalecm \relax
        ...
        \fi
%
        \pgfmathparse{\sseq@tempydimen/1cm/(\sseq@ymax-\sseq@ymin)}
        \ifdim \pgfmathresult cm < \sseq@yscale cm
            \sseq@tempy = \numexpr \sseq@tempydimen /\sseq@yscalecm \relax
