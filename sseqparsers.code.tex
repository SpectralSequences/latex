...
\prg_new_conditional:Npnn \sseq_if_out_of_bounds:n #1 { T ,  F , TF } {
    ...
    \sseq_if_out_of_bounds_noparse:nnTF { \xcoord } { \ycoord }{\prg_return_true:}{\prg_return_false:}
}
...
\def\sseq@defer@tikzcommand@option[#1]{%
    ...
    \ifx\sseq@savedoptioncode\pgfutil@empty\else
        \sseq@x@addto@macro\sseq@thepathsofar{[/utils/exec={\unexpanded\@xp{\sseq@savedoptioncode}}]}%\@nx\tracingall
    \fi
