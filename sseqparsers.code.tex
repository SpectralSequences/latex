...
\def\sseq@parsecoord@maincoord@#1\sseq@relax{%
    ...
    \else
        ...
        \else
            %\show\sseq@classname@handler
            \sseq@classname@handler{#1}
            \sseq@obj@ifdef{class.namedclass.\detokenize\@xp{\processedname}}{
                \let\sourcename\processedname
                \@xpthree\sseq@parsecoord@maincoord@named\sseq@obj{class.namedclass.\sourcename}\sseq@nil
            }{
...
\protected\def\sseqnormalizemonomial#1{
    \bgroup
    \def\sseq@support{}
    \sseq@ifempty{#1}{\egroup\def\processedlabel{1}}{
