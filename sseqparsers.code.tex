...
\def\sseq@grabdpage@token#1{
    ...
    \else
        \@xp\sseq@grabdpage@token@fexpcs\@xp#1
    \fi
}
...
\def\sseq@defer@tikzcommand#1{%
    ...
    \sseq@loadinputline
    \sseq@callas{#1}%
    \gdef\sseq@thepathsofar{#1[/utils/exec={\sseq@thesseqstyle\sseq@thetikzprimitivestyle\the\sseq@scope@toks\sseq@savedoptioncode\sseq@collections@tikzprimitive@hook}]}%
