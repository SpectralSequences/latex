...
\sseq@pgfqkeysdirlist{/sseqpages,/sseqpages/tikz primitives}{%
    ...
    background/.code={\sseq@backgroundpathstrue\sseq@setsavedpaths{background}\pgfkeysalso{standard parse}},
...
\pgfqkeys{/sseqpages/global}{%
    ...
    width/.sseq store dimen in=\sseq@fitwidth{},
    width/.append code={},
    height/.sseq store dimen in=\sseq@fitheight{},
    xscale/.code={%
...
% \ifsseq@backgroundpaths is used to save time on 
\sseq@addiftostorelist{backgroundpaths}
\sseq@pgfqkeysdirlist{/sseqpages/scope,/sseqpages/tikz primitives}{
    ...
    background/.code={\sseq@backgroundpathstrue\sseq@standardparse\sseq@setsavedpaths{background}\pgfkeysalso{standard parse}},
}
