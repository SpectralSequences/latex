...
\sseq@globalkeys{%
    ...
    x grid step/.sseq store in=\sseq@xgridstep{1},
    y grid step/.sseq store in=\sseq@ygridstep{1},
...
%
    ...
    x tick offset/.sseq store in=\sseq@xtickstepoffset{0},
    y tick offset/.sseq store in=\sseq@ytickstepoffset{0},
...
\sseq@addtostorelist\sseq@xscale{1cm}
\sseq@addtostorelist\sseq@yscale{1cm}
...
\pgfqkeys{/sseqpages/global}{%
    ...
    xscale/.code={%
        ...
        \fi
        \sseq@globalscaleoption{\pgfsetxvec{\pgfpointxy{#1}{0cm}}}%
        \pgfmathparse{\sseq@xscale*#1}
        \edef\sseq@xscale{\pgfmathresult pt}
    },
    ...
    yscale/.code={%
        ...
        \fi
        \sseq@globalscaleoption{\pgfsetyvec{\pgfpointxy{0cm}{#1}}}%
        \edef\sseq@yscale{\the\dimexpr\sseq@yscale*#1}
    },
