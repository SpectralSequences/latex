...
\sseq@newerror{range-overflow}{The #1 range #2 is too large. The maximum #1 range possible with the current #1scale is xmax - xmin = #3. The maximum #1scale possible with the current #1range is #4. Either change the scale or the range as appropriate.}
