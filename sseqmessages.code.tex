...
\sseq@newerror{invalid-value-not-intexpr}{The value #2 provided for key '#1' is not a valid integer expression.}
\sseq@newerror{invalid-value-not-positive-intexpr}{The value #2 provided for key '#1' does not evaluate to a positive integer.}
