...
%
    ...
    \sseq@tempcount = \numexpr -1 +\sseq@tempdimen /\sseq@xscalecm \relax
    \ifnum \numexpr\sseq@xmax-\sseq@xmin > \sseq@tempcount
      \pgfmathparse{\sseq@tempdimen/1cm/(\sseq@xmax-\sseq@xmin)}
...
%
    ...
    \sseq@tempcount = \numexpr -1 +\sseq@tempdimen /\sseq@yscalecm \relax
    \ifnum \numexpr\sseq@ymax-\sseq@ymin > \sseq@tempcount
        \pgfmathparse{\sseq@tempdimen/1cm/(\sseq@ymax-\sseq@ymin)}
...
\sseq@DeclareDocumentCommand\structlineoptions{od()}{%
    ...
    \IfNoValueTF{#2}{
        ...
        \def\next{\sseq@structline@{structlineoptions}{#1}{#2}}%
        \@xptwo\next\sseq@trimleadingspaces
    }
}
