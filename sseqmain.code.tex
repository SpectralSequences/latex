...
\sseq@DeclareDocumentCommand\structline{od()}{%
    \begingroup
    \def\next{\sseq@structline@main{structline}{#1}{#2}}%
    \@xptwo\next\sseq@trimleadingspaces
}
\sseq@DeclareDocumentCommand\structlineoptions{od()}{%
    \begingroup
    \def\next{\sseq@structline@main{structlineoptions}{#1}{#2}}%
    \@xptwo\next\sseq@trimleadingspaces
}

\sseq@DeclareDocumentCommandAs\sseq@structline@main\structline{mmmd()}{%
