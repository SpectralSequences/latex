...
%
    ...
    \protected\def\xmin{\sseq@xmin}\protected\def\xmax{\sseq@xmax}
    \protected\def\ymin{\sseq@ymin}\protected\def\ymax{\sseq@ymax}
%
...
\def\sseq@class@copy#1#2{
    ...
    \sseq@lettoobj\sseq@class@showname{#2.showname}
...
\def\sseq@handleclassquotes@inner#1#2{%
    ...
    \sseq@classlabel@handler{#1}% labeltextfn is a private handler, sseq@classlabel@handler is exposed via "class label handler"
    \ifsseq@classlabel
        \sseq@options@firstpassmode
