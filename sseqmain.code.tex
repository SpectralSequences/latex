...
%
    \bgroup
    \def\sseq@xscale{1cm}\def\sseq@yscale{1cm}
    \sseq@xscalecm=\sseq@xscale cm
    \sseq@yscalecm=\sseq@yscale cm
    ...
    \xdef\sseq@totalxmargin{\the\dimexpr\wd\sseq@measureheightwidthbox - \sseq@xscalecm*(\sseq@xmax-\sseq@xmin)}
    \xdef\sseq@totalymargin{\the\dimexpr\ht\sseq@measureheightwidthbox - \sseq@yscalecm*(\sseq@ymax-\sseq@ymin)}
    \egroup
    \ifx\sseq@fitwidth\pgfutil@empty % Check to make sure chart will fit on page
        \sseq@tempdimen = \dimexpr \textwidth - \sseq@totalxmargin\relax
    ...
    \else % scale to fit target width
        \sseq@tempdimen = \dimexpr \sseq@fitwidth - \sseq@totalxmargin\relax
        \sseq@xscalecm = \dimexpr\sseq@tempdimen/(\sseq@xmax-\sseq@xmin)\relax
        \pgfmathsetmacro\sseq@xscale{\sseq@xscalecm /1cm}
        \sseq@globalscaleoption{\pgfsetxvec{\pgfpoint{\sseq@xscalecm}{0cm}}}
    \fi
%
    ...
    \else % Set yscale to fit target height
        \sseq@tempdimen = \dimexpr \sseq@fitheight - \sseq@totalymargin\relax
        \sseq@yscalecm = \dimexpr\sseq@tempdimen/(\sseq@ymax-\sseq@ymin)\relax
        \pgfmathsetmacro\sseq@yscale{\sseq@yscalecm /1cm}
        \sseq@globalscaleoption{\pgfsetyvec{\pgfpoint{0cm}{\sseq@yscalecm}}}
    \fi
%
