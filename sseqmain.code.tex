...
\def\sseq@scope@[#1]{%
    ...
    \sseq@eval{\sseq@scope@toks{\unexpanded\@xp{\the\sseq@scope@toks}\unexpanded\@xp{\sseq@savedoptioncode\tikz@options}}}
    \sseq@eval{\@nx\sseq@scope@savedpaths@add{\sseq@scope@toks{\the\sseq@scope@toks}}}%
