...
\usepackage[landscape,paperheight=15in,margin=0.1in,top=0.5in]{geometry}
\usepackage{spectralsequences}

% figure out how to get width("\noexpand\small 16") working
\sseqset{ppower/.style={rectangle,font=\tiny,minimum height=10pt,minimum width=10pt,class labels=inside,"#1"}}
\begin{document}
...
\class["\alpha_{4/4}" {font=\small},ppower=16,"16" {inside,font=\tiny}](7,1)
\DoUntilOutOfBoundsThenNMore{3}{\etaclass}
...
\class["\alpha_{8/5}" {font=\small},ppower=32,"32" {inside,font=\tiny}](15,1)
\DoUntilOutOfBoundsThenNMore{3}{\etaclass}
...
\etaclass\structline(\lastclass)(6,2,1) % This is a *nu

\class["\beta_3" left](14,2)
\etaclass(14,2,-1)
\divetaclass["\beta_{4/4}" left]
...
\class["\beta_{4/3}"](16,2)
\etaclass\etaclass
\class["\beta_{4/2,2}",circlen=2](18,2)
\structline[dashed,bend right=20](18,2,-1)(18,4,-1)

\class["\eta_2"](19,3)
\etaclass

\class["\beta_{4}"below](20,2)
\structline[dashed](20,2,-1)(20,4,2)
%\structlineoptions[bend left=20](20,2,-1)(20,4,2) % page=0--3
