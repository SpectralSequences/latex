...
\sseqset{
    ...
    width = \textwidth - 10pt,
    height = \textheight - 10pt,
    bocksteinSS/.style={
        page=0, y range={-1}{0},
        no differentials, no labels, no y ticks, no title,
        xscale=1,yscale=1.5, x axis extend end=40pt, y axis extend end = 40pt, x axis gap =50pt,
        class label handler = {},
    }
}
...
\begin{sseqpage}[ name=K(Z/3;3), bocksteinSS,xscale=1 ]
\begin{scope}[background]
