...
\def\sseq@grid@go{
 ...
 \pgfpathgrid[stepx=\pgf@xa,stepy=\pgf@ya]
    { \pgfpointxy
        ...
        { \ymin - \sseq@tempy +\sseq@yoffset} }
    { \pgfpointxy
        { \xmax + \sseq@tempxb - 0.01 +\sseq@xoffset + 1 }
        { \ymax + \sseq@tempyb - 0.01 +\sseq@yoffset + 1 }
    }
 \pgfusepath{stroke}
 \endpgfscope
 \egroup
...
\def\sseq@offset#1#2{
    \sseq@eval{\@nx\pgftransformshift{
        \@nx\pgfpointxy
            ...
            { 0\csname sseq@\sseq@classpattern yoffset#1/#2\endcsname }
    }}
}
...
\patchcmd\sseq@tikz@@@to@compute@relative{%
    ...
    \pgf@process{\pgfpointadd{\tikz@toto}{\pgfpointxy{\sseq@xoffset}{\sseq@yoffset}}}%
