...
\def\sseq@transform@xymirror{
    \pgftransformcm{0}{1}{1}{0}{\pgfqpointxy{\sseq@xoffset}{\sseq@yoffset}} % Reflect x and y axes,
    \pgftransformshift{\pgfqpointxy{-\sseq@xoffset}{-\sseq@yoffset}}    % but we need to conjugate by a shift of (xoffset,yoffset)
}
