...
\def\sseq@totalxmargin{(\sseq@clip@padding@right + \sseq@xaxis@end@extend + \sseq@xaxis@start@extend + \sseq@yaxisgap)}
\def\sseq@totalymargin{(\sseq@clip@padding@top + \sseq@yaxis@end@extend + \sseq@yaxis@start@extend + \sseq@xaxisgap)}
%%%
%%% Draw axes and clip
%%%
