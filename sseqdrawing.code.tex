...
\def\sseq@transform@xymirror{
    ...
    \pgftransformcm{0}{1}{1}{0}{\pgfpointxy{\sseq@xoffset*\sseq@xscale }{\sseq@yoffset}} % Reflect x and y axes,
    \pgftransformshift{\pgfpointxy{-\sseq@xoffset*\sseq@yscale}{-\sseq@yoffset}}    % but we need to conjugate by a shift of (xoffset,yoffset)
...
\def\sseq@rightgridpadding@yframe{5cm} % Just make it big enough to push off the end of the
