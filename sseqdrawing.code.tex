...
\def\sseq@setlayoutparameters{
    ...
    \sseq@setlayoutparameter{totalymargin}{x\sseq@xaxistype}
%
    ...
    \sseq@setlayoutparameter{totalxmargin}{y\sseq@xaxistype}
}
...
% Some fudge here...
\def\sseq@totalxmargin@yborder{(\sseq@clip@padding@right + \sseq@xaxis@end@extend + \sseq@xaxisstartoffset + 0.2001pt )}
\def\sseq@totalxmargin@yframe{(\sseq@clip@padding@right + \sseq@xaxis@end@extend + \sseq@xaxisstartoffset + 4pt)}

\def\sseq@totalymargin@xborder{(\sseq@clip@padding@top + \sseq@yaxis@end@extend + \sseq@yaxisstartoffset + 0.2001pt)}
\def\sseq@totalymargin@xframe{(\sseq@bottomclippadding + \sseq@topclippadding)}
%%%
%%% Draw axes and clip
%%%
...
\def\sseq@setnodetext#1#2{%
    \sseq@ifempty{#2}{% more often than not, the node is empty...
