...
\def\sseq@grid@chess{
 ...
 \fi
 \pgfpathgrid[stepx=2cm,stepy=2cm]{\pgfpoint{-0.5cm+\the\sseq@tempx cm}{-0.5cm+\the\sseq@tempy cm}}{\pgfpoint{\the\sseq@tempxb cm+0.499cm}{\the\sseq@tempyb cm+0.499cm}}
 \pgfusepath{stroke}
 \endpgfscope
 \egroup
}
\def\sseq@grid@crossword{
 ...
 \pgfpathgrid[stepx=1cm,stepy=1cm]{\pgfpoint{\xmin cm-1cm}{\ymin cm-1cm}}{\pgfpoint{\xmax cm+0.99cm}{\ymax cm+0.99cm}}
 \pgfusepath{stroke}
 \endpgfscope
 \egroup
}
\def\sseq@grid@go{
 ...
 \pgfsetcolor{\sseq@gridcolor}
 \pgfsetlinewidth{\the\sseq@gridstrokethickness}
 \pgfpathgrid[stepx=1cm,stepy=1cm]{\pgfpoint{\xmin cm-1cm}{\ymin cm-1cm}}{\pgfpoint{\xmax cm+0.5cm}{\ymax cm+0.5cm}}
 \pgfusepath{stroke}
 \endpgfscope
 \egroup
}
